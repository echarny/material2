...
ItemSizeAverager = /** @class */ (function () {
    ...
    /** Returns the average item size. */
    ItemSizeAverager.prototype.getAverageItemSize = /** Returns the average item size. */
    function () {
    ...
    /** Resets the averager. */
    /** Resets the averager. */
    ItemSizeAverager.prototype.reset = /** Resets the averager. */
    function () {
...
var /** Virtual scrolling strategy for lists with items of unknown or dynamic size. */
AutoSizeVirtualScrollStrategy = /** @class */ (function () {
    ...
    function AutoSizeVirtualScrollStrategy(minBufferPx, maxBufferPx, averager) {
        ...
        this.scrolledIndexChange = rxjs_1.Observable.create(function () {
    ...
    /** Detaches this scroll strategy from the currently attached viewport. */
    AutoSizeVirtualScrollStrategy.prototype.detach = /** Detaches this scroll strategy from the currently attached viewport. */
    function () {
        this._viewport = null;
    };
    /** @docs-private Implemented as part of VirtualScrollStrategy. */
    /** @docs-private Implemented as part of VirtualScrollStrategy. */
    AutoSizeVirtualScrollStrategy.prototype.onContentScrolled = /** @docs-private Implemented as part of VirtualScrollStrategy. */
    function () {
        if (this._viewport) {
    ...
    /** @docs-private Implemented as part of VirtualScrollStrategy. */
    /** @docs-private Implemented as part of VirtualScrollStrategy. */
    AutoSizeVirtualScrollStrategy.prototype.onDataLengthChanged = /** @docs-private Implemented as part of VirtualScrollStrategy. */
    function () {
        if (this._viewport) {
            this._setScrollOffset();
    ...
    /** @docs-private Implemented as part of VirtualScrollStrategy. */
    /** @docs-private Implemented as part of VirtualScrollStrategy. */
    AutoSizeVirtualScrollStrategy.prototype.onContentRendered = /** @docs-private Implemented as part of VirtualScrollStrategy. */
    function () {
        if (this._viewport) {
            this._checkRenderedContentSize();
        }
    ...
    /** @docs-private Implemented as part of VirtualScrollStrategy. */
    /** @docs-private Implemented as part of VirtualScrollStrategy. */
    AutoSizeVirtualScrollStrategy.prototype.onRenderedOffsetChanged = /** @docs-private Implemented as part of VirtualScrollStrategy. */
    function () {
        if (this._viewport) {
    ...
    /** Scroll to the offset for the given index. */
    AutoSizeVirtualScrollStrategy.prototype.scrollToIndex = /** Scroll to the offset for the given index. */
    function () {
        // TODO(mmalerba): Implement.
    ...
    /** Update the rendered content after the user scrolls. */
    AutoSizeVirtualScrollStrategy.prototype._updateRenderedContentAfterScroll = /** Update the rendered content after the user scrolls. */
    function () {
    ...
    /** Checks the currently rendered content offset and saves the value for later use. */
    AutoSizeVirtualScrollStrategy.prototype._checkRenderedContentOffset = /** Checks the currently rendered content offset and saves the value for later use. */
    function () {
        var viewport = (this._viewport);
    ...
    /** Update the viewport's total content size. */
    AutoSizeVirtualScrollStrategy.prototype._updateTotalContentSize = /** Update the viewport's total content size. */
...
var CdkAutoSizeVirtualScroll = /** @class */ (function () {
    ...
    CdkAutoSizeVirtualScroll.decorators = [
        { type: core_1.Directive, args: [{
                    ...
                    providers: [{
                            provide: scrolling_1.VIRTUAL_SCROLL_STRATEGY,
                            useFactory: _autoSizeVirtualScrollStrategyFactory,
                            deps: [core_1.forwardRef(function () { return CdkAutoSizeVirtualScroll; })],
                        }],
                },] },
    ];
    /** @nocollapse */
