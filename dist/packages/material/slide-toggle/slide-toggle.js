...
var nextUniqueId = 0;
exports.MAT_SLIDE_TOGGLE_VALUE_ACCESSOR = {
    provide: forms_1.NG_VALUE_ACCESSOR,
    useExisting: core_1.forwardRef(function () { return MatSlideToggle; }),
    multi: true
};
/** Change event object emitted by a MatSlideToggle. */
var /** Change event object emitted by a MatSlideToggle. */
MatSlideToggleChange = /** @class */ (function () {
    function MatSlideToggleChange(/** The source MatSlideToggle of the event. */
...
exports._MatSlideToggleMixinBase = core_2.mixinTabIndex(core_2.mixinColor(core_2.mixinDisableRipple(core_2.mixinDisabled(MatSlideToggleBase)), 'accent'));
...
var MatSlideToggle = /** @class */ (function (_super) {
    ...
    _platform, _focusMonitor, _changeDetectorRef, tabIndex, _ngZone, defaults, _animationMode, _dir) {
        ...
        /**
           ...
           */
        _this.toggleChange = new core_1.EventEmitter();
        /**
           ...
           */
        _this.dragChange = new core_1.EventEmitter();
        _this.tabIndex = parseInt(tabIndex) || 0;
        return _this;
    }
    Object.defineProperty(MatSlideToggle.prototype, "required", {
        get: /** Whether the slide-toggle is required. */
    ...
    Object.defineProperty(MatSlideToggle.prototype, "checked", {
        get: /** Whether the slide-toggle element is checked or not */
        function () { return this._checked; },
        set: function (value) {
            this._checked = coercion_1.coerceBooleanProperty(value);
    ...
    /** Method being called whenever the underlying input emits a change event. */
    MatSlideToggle.prototype._onChangeEvent = /** Method being called whenever the underlying input emits a change event. */
    function (event) {
    ...
    /** Method being called whenever the slide-toggle has been clicked. */
    MatSlideToggle.prototype._onInputClick = /** Method being called whenever the slide-toggle has been clicked. */
    function (event) {
    ...
    /** Implemented as part of ControlValueAccessor. */
    MatSlideToggle.prototype.writeValue = /** Implemented as part of ControlValueAccessor. */
    function (value) {
        this.checked = !!value;
    };
    /** Implemented as part of ControlValueAccessor. */
    /** Implemented as part of ControlValueAccessor. */
    MatSlideToggle.prototype.registerOnChange = /** Implemented as part of ControlValueAccessor. */
    function (fn) {
        this.onChange = fn;
    };
    /** Implemented as part of ControlValueAccessor. */
    /** Implemented as part of ControlValueAccessor. */
    MatSlideToggle.prototype.registerOnTouched = /** Implemented as part of ControlValueAccessor. */
    function (fn) {
        this.onTouched = fn;
    };
    /** Implemented as a part of ControlValueAccessor. */
    /** Implemented as a part of ControlValueAccessor. */
    MatSlideToggle.prototype.setDisabledState = /** Implemented as a part of ControlValueAccessor. */
    function (isDisabled) {
    ...
    /** Focuses the slide-toggle. */
    MatSlideToggle.prototype.focus = /** Focuses the slide-toggle. */
    function () {
        this._focusMonitor.focusVia(this._inputElement.nativeElement, 'keyboard');
    };
    /** Toggles the checked state of the slide-toggle. */
    /** Toggles the checked state of the slide-toggle. */
    MatSlideToggle.prototype.toggle = /** Toggles the checked state of the slide-toggle. */
    function () {
    ...
    /** Retrieves the percentage of thumb from the moved distance. Percentage as fraction of 100. */
    MatSlideToggle.prototype._getDragPercentage = /** Retrieves the percentage of thumb from the moved distance. Percentage as fraction of 100. */
    function (distance) {
    ...
    /** Method being called whenever the label text changes. */
    MatSlideToggle.prototype._onLabelTextChange = /** Method being called whenever the label text changes. */
    function () {
    ...
    MatSlideToggle.decorators = [
        { type: core_1.Component, args: [{selector: 'mat-slide-toggle',
                    ...
                    providers: [exports.MAT_SLIDE_TOGGLE_VALUE_ACCESSOR],
    ...
    MatSlideToggle.ctorParameters = function () { return [
        ...
        { type: core_1.NgZone, },
        { type: undefined, decorators: [{ type: core_1.Inject, args: [slide_toggle_config_1.MAT_SLIDE_TOGGLE_DEFAULT_OPTIONS,] },] },
    ...
    MatSlideToggle.propDecorators = {
        "_thumbEl": [{ type: core_1.ViewChild, args: ['thumbContainer',] },],
        "_thumbBarEl": [{ type: core_1.ViewChild, args: ['toggleBar',] },],
        ...
        "toggleChange": [{ type: core_1.Output },],
        "dragChange": [{ type: core_1.Output },],
        "_inputElement": [{ type: core_1.ViewChild, args: ['input',] },],
    };
    return MatSlideToggle;
}(exports._MatSlideToggleMixinBase));
