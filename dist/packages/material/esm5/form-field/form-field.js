 ...
 * \@docs-private
 */
export { MatFormFieldBase };
function MatFormFieldBase_tsickle_Closure_declarations() {
    /** @type {?} */
 ...
 * \@docs-private
 */
export var /** @type {?} */ _MatFormFieldMixinBase = mixinColor(MatFormFieldBase, 'primary');
/**
...
function MatFormFieldDefaultOptions_tsickle_Closure_declarations() {
    /** @type {?|undefined} */
 ...
 */
export var /** @type {?} */ MAT_FORM_FIELD_DEFAULT_OPTIONS = new InjectionToken('MAT_FORM_FIELD_DEFAULT_OPTIONS');
/**
...
function MatFormField_tsickle_Closure_declarations() {
    ...
    /** @type {?} */
    MatFormField.prototype._defaultOptions;
    /** @type {?} */
