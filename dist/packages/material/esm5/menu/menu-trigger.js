 ...
 */
export var /** @type {?} */ MAT_MENU_SCROLL_STRATEGY = new InjectionToken('mat-menu-scroll-strategy');
/**
 * \@docs-private
 * @param {?} overlay
 * @return {?}
 ...
 * \@docs-private
 */
export var /** @type {?} */ MAT_MENU_SCROLL_STRATEGY_FACTORY_PROVIDER = {
 ...
 */
export var /** @type {?} */ MENU_PANEL_TOP_PADDING = 8;
/**
...
var MatMenuTrigger = /** @class */ (function () {
    ...
    function () {
        ...
        var /** @type {?} */ parentClose = this._parentMenu ? this._parentMenu.closed : observableOf();
        var /** @type {?} */ hover = this._parentMenu ? this._parentMenu._hovered().pipe(filter(function (active) { return active !== _this._menuItemInstance; }), filter(function () { return _this._menuOpen; })) : observableOf();
