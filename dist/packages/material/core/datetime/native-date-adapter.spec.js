...
var month_constants_1 = require("../testing/month-constants");
...
describe('NativeDateAdapter', function () {
    ...
    it('should get year', function () {
        expect(adapter.getYear(new Date(2017, month_constants_1.JAN, 1))).toBe(2017);
    });
    it('should get month', function () {
        expect(adapter.getMonth(new Date(2017, month_constants_1.JAN, 1))).toBe(0);
    });
    it('should get date', function () {
        expect(adapter.getDate(new Date(2017, month_constants_1.JAN, 1))).toBe(1);
    });
    it('should get day of week', function () {
        expect(adapter.getDayOfWeek(new Date(2017, month_constants_1.JAN, 1))).toBe(0);
    });
    ...
    it('should get year name', function () {
        expect(adapter.getYearName(new Date(2017, month_constants_1.JAN, 1))).toBe('2017');
    });
    it('should get year name in a different locale', function () {
        adapter.setLocale('ja-JP');
        if (SUPPORTS_INTL) {
            expect(adapter.getYearName(new Date(2017, month_constants_1.JAN, 1))).toBe('2017年');
        }
        else {
            expect(adapter.getYearName(new Date(2017, month_constants_1.JAN, 1))).toBe('2017');
        }
    ...
    it('should create Date', function () {
        expect(adapter.createDate(2017, month_constants_1.JAN, 1)).toEqual(new Date(2017, month_constants_1.JAN, 1));
    });
    it('should not create Date with month over/under-flow', function () {
        expect(function () { return adapter.createDate(2017, month_constants_1.DEC + 1, 1); }).toThrow();
        expect(function () { return adapter.createDate(2017, month_constants_1.JAN - 1, 1); }).toThrow();
    });
    it('should not create Date with date over/under-flow', function () {
        expect(function () { return adapter.createDate(2017, month_constants_1.JAN, 32); }).toThrow();
        expect(function () { return adapter.createDate(2017, month_constants_1.JAN, 0); }).toThrow();
    });
    it('should create Date with low year number', function () {
        expect(adapter.createDate(-1, month_constants_1.JAN, 1).getFullYear()).toBe(-1);
        expect(adapter.createDate(0, month_constants_1.JAN, 1).getFullYear()).toBe(0);
        expect(adapter.createDate(50, month_constants_1.JAN, 1).getFullYear()).toBe(50);
        expect(adapter.createDate(99, month_constants_1.JAN, 1).getFullYear()).toBe(99);
        expect(adapter.createDate(100, month_constants_1.JAN, 1).getFullYear()).toBe(100);
    });
    ...
    it('should parse string', function () {
        expect(adapter.parse('1/1/2017')).toEqual(new Date(2017, month_constants_1.JAN, 1));
    });
    ...
    it('should parse Date', function () {
        var date = new Date(2017, month_constants_1.JAN, 1);
    ...
    it('should format', function () {
        if (SUPPORTS_INTL) {
            expect(adapter.format(new Date(2017, month_constants_1.JAN, 1), {})).toEqual('1/1/2017');
        }
        else {
            expect(adapter.format(new Date(2017, month_constants_1.JAN, 1), {})).toEqual('Sun Jan 01 2017');
        }
    });
    it('should format with custom format', function () {
        if (SUPPORTS_INTL) {
            expect(adapter.format(new Date(2017, month_constants_1.JAN, 1), {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
    ...
    it('should format with a different locale', function () {
        ...
        if (SUPPORTS_INTL) {
            ...
            if (platform.EDGE || platform.TRIDENT) {
                expect(adapter.format(new Date(2017, month_constants_1.JAN, 1), {})).toEqual('2017年1月1日');
            }
            else {
                expect(adapter.format(new Date(2017, month_constants_1.JAN, 1), {})).toEqual('2017/1/1');
            }
        }
        else {
            expect(adapter.format(new Date(2017, month_constants_1.JAN, 1), {})).toEqual('Sun Jan 01 2017');
    ...
    it('should add years', function () {
        expect(adapter.addCalendarYears(new Date(2017, month_constants_1.JAN, 1), 1)).toEqual(new Date(2018, month_constants_1.JAN, 1));
        expect(adapter.addCalendarYears(new Date(2017, month_constants_1.JAN, 1), -1)).toEqual(new Date(2016, month_constants_1.JAN, 1));
    });
    it('should respect leap years when adding years', function () {
        expect(adapter.addCalendarYears(new Date(2016, month_constants_1.FEB, 29), 1)).toEqual(new Date(2017, month_constants_1.FEB, 28));
        expect(adapter.addCalendarYears(new Date(2016, month_constants_1.FEB, 29), -1)).toEqual(new Date(2015, month_constants_1.FEB, 28));
    });
    it('should add months', function () {
        expect(adapter.addCalendarMonths(new Date(2017, month_constants_1.JAN, 1), 1)).toEqual(new Date(2017, month_constants_1.FEB, 1));
        expect(adapter.addCalendarMonths(new Date(2017, month_constants_1.JAN, 1), -1)).toEqual(new Date(2016, month_constants_1.DEC, 1));
    });
    it('should respect month length differences when adding months', function () {
        expect(adapter.addCalendarMonths(new Date(2017, month_constants_1.JAN, 31), 1)).toEqual(new Date(2017, month_constants_1.FEB, 28));
        expect(adapter.addCalendarMonths(new Date(2017, month_constants_1.MAR, 31), -1)).toEqual(new Date(2017, month_constants_1.FEB, 28));
    });
    it('should add days', function () {
        expect(adapter.addCalendarDays(new Date(2017, month_constants_1.JAN, 1), 1)).toEqual(new Date(2017, month_constants_1.JAN, 2));
        expect(adapter.addCalendarDays(new Date(2017, month_constants_1.JAN, 1), -1)).toEqual(new Date(2016, month_constants_1.DEC, 31));
    });
    ...
    it('should compare dates', function () {
        expect(adapter.compareDate(new Date(2017, month_constants_1.JAN, 1), new Date(2017, month_constants_1.JAN, 2))).toBeLessThan(0);
        expect(adapter.compareDate(new Date(2017, month_constants_1.JAN, 1), new Date(2017, month_constants_1.FEB, 1))).toBeLessThan(0);
        expect(adapter.compareDate(new Date(2017, month_constants_1.JAN, 1), new Date(2018, month_constants_1.JAN, 1))).toBeLessThan(0);
        expect(adapter.compareDate(new Date(2017, month_constants_1.JAN, 1), new Date(2017, month_constants_1.JAN, 1))).toBe(0);
        expect(adapter.compareDate(new Date(2018, month_constants_1.JAN, 1), new Date(2017, month_constants_1.JAN, 1))).toBeGreaterThan(0);
        expect(adapter.compareDate(new Date(2017, month_constants_1.FEB, 1), new Date(2017, month_constants_1.JAN, 1))).toBeGreaterThan(0);
        expect(adapter.compareDate(new Date(2017, month_constants_1.JAN, 2), new Date(2017, month_constants_1.JAN, 1))).toBeGreaterThan(0);
    });
    it('should clamp date at lower bound', function () {
        expect(adapter.clampDate(new Date(2017, month_constants_1.JAN, 1), new Date(2018, month_constants_1.JAN, 1), new Date(2019, month_constants_1.JAN, 1)))
            .toEqual(new Date(2018, month_constants_1.JAN, 1));
    });
    it('should clamp date at upper bound', function () {
        expect(adapter.clampDate(new Date(2020, month_constants_1.JAN, 1), new Date(2018, month_constants_1.JAN, 1), new Date(2019, month_constants_1.JAN, 1)))
            .toEqual(new Date(2019, month_constants_1.JAN, 1));
    });
    it('should clamp date already within bounds', function () {
        expect(adapter.clampDate(new Date(2018, month_constants_1.FEB, 1), new Date(2018, month_constants_1.JAN, 1), new Date(2019, month_constants_1.JAN, 1)))
            .toEqual(new Date(2018, month_constants_1.FEB, 1));
    });
