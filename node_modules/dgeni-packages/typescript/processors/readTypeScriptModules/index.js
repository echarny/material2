...
function readTypeScriptModules(tsParser, modules, exportSymbolsToDocsMap, createDocMessage, log) {
    ...
    ReadTypeScriptModules.prototype.addExportDocs = function (docs, moduleDoc) {
        ...
        moduleDoc.symbol.exportArray.forEach(function (exportSymbol) {
            ...
            switch (TsParser_1.getExportDocType(resolvedExport)) {
                case 'class':
                    var classDoc = new ClassExportDoc_1.ClassExportDoc(moduleDoc, resolvedExport, aliasSymbol);
                    ...
                    break;
                case 'interface':
                    var interfaceDoc = new InterfaceExportDoc_1.InterfaceExportDoc(moduleDoc, resolvedExport, aliasSymbol);
                    _this.addMemberDocs(docs, interfaceDoc.members);
                    _this.addExportDoc(docs, moduleDoc, interfaceDoc);
                    break;
                case 'enum':
                    var enumDoc = new EnumExportDoc_1.EnumExportDoc(moduleDoc, resolvedExport, aliasSymbol);
                ...
                case 'let':
                case 'var':
                    _this.addExportDoc(docs, moduleDoc, new ConstExportDoc_1.ConstExportDoc(moduleDoc, resolvedExport, aliasSymbol));
                    break;
                case 'type-alias':
                    _this.addExportDoc(docs, moduleDoc, new TypeAliasExportDoc_1.TypeAliasExportDoc(moduleDoc, resolvedExport, aliasSymbol));
                    break;
                case 'function':
                    var functionDoc = new FunctionExportDoc_1.FunctionExportDoc(moduleDoc, resolvedExport, aliasSymbol);
