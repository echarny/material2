    ...
    ContainerExportDoc.prototype.getMemberDocs = function (members, hidePrivateMembers) {
        ...
        members.forEach(function (member) {
            ...
            for (var _i = 0, _a = member.getDeclarations(); _i < _a.length; _i++) {
                ...
                if (flags & MethodMemberFlags) {
                    if (declaration.kind === typescript_1.SyntaxKind.GetAccessor) {
                        ...
                        memberDoc = new MethodMemberDoc_1.MethodMemberDoc(_this, member, declaration, overloads);
                    }
                    else {
                        // This is an overload signature of the method
                        overloads.push(new MethodMemberDoc_1.MethodMemberDoc(_this, member, declaration, overloads));
                    }
                }
                else if (flags & PropertyMemberFlags) {
                    memberDoc = new PropertyMemberDoc_1.PropertyMemberDoc(_this, member, declaration, null, null);
                }
                else {
            ...
            if (getAccessorDeclaration || setAccessorDeclaration) {
                memberDoc = new PropertyMemberDoc_1.PropertyMemberDoc(_this, member, null, getAccessorDeclaration, setAccessorDeclaration);
            }
