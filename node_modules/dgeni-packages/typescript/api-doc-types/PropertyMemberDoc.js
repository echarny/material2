...
var PropertyMemberDoc = /** @class */ (function (_super) {
    ...
    function PropertyMemberDoc(containerDoc, symbol, declaration, getAccessorDeclaration, setAccessorDeclaration) {
        var _this = 
        ...
        _super.call(this, containerDoc, symbol, (declaration || getAccessorDeclaration || setAccessorDeclaration)) || this;
        ...
        _this.getAccessor = getAccessorDeclaration && new AccessorInfoDoc_1.AccessorInfoDoc('get', _this, getAccessorDeclaration);
