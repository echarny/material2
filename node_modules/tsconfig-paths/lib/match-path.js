 ...
 */
function matchFromAbsolutePaths(absolutePathMappings, absoluteSourceFileName, requestedModule, 
    // tslint:disable-next-line:no-any
    readPackageJson, fileExists, extensions) {
    // tslint:disable-next-line:no-any
 ...
 * @returns {string}
 */
function tryResolve(physicalPath, 
    // tslint:disable-next-line:no-any
    fileExists, 
    // tslint:disable-next-line:no-any
    readPackageJson, extensions) {
